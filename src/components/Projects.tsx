        ...
        <div className="grid gap-12 lg:grid-cols-3">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group relative rounded-2xl bg-zinc-900 overflow-hidden border border-white/10"
            >
              {/* Image Placeholder area */}
              <div className={`h-48 w-full bg-gradient-to-br ${project.color} opacity-80 transition-opacity group-hover:opacity-100`}></div>
