...
const techStack = [
  ...
  { name: "Python", icon: <FileCode2 />, category: "Language" },
  { name: "Java", icon: <FileCode2 />, category: "Language" },
...
const coreSkills = [
  ...
  { name: "Secure KYC Implementation", icon: <ShieldCheck className="w-4 h-4" /> },
];
...
export default function TechStack() {
  return (
    <section id="skills" className="relative z-10 py-32 overflow-hidden bg-black">
      ...
      {/* Central glow effect */}
      <div className="absolute left-1/2 top-1/2 -z-10 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 bg-purple-600/20 blur-[120px]" />
                    ...
                    {certificates.map((cert, index) => (
                        ...
                        >
                            <div className="relative z-10 flex items-start gap-4">
                                ...
                                <span className="text-zinc-400 group-hover:text-zinc-200 transition-colors">{cert}</span>
                            </div>
